export class Configure {
   urlLogin = "http://localhost:4000/auth/login"
   urlCreateAccount = "http://localhost:4000/admin/account/create"
   urlListAccount = "http://localhost:4000/admin/account/get-list"
  ...
  urlurlUnlockAccountById = "http://localhost:4000/admin/account/delete/"
